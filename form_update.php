            ...
            <div class="card-body">
                <form action="act_update.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <br><br>
                        <label>Brand :</label>
                        <input type="text" name="brand" value="<?= $data1['brand']; ?>">
                        <br><br>
                        <label>Detail tipe :</label>
                        <input type="text" name="detail_tipe" value="<?= $data1['detail_tipe']; ?>">
                        <br><br>
                        <label>Nomor serial :</label>
                        <input type="text" name="nomor_serial" value="<?= $data1['nomor_serial']; ?>">
                        <br><br>
                        <label>Pengirim :</label>
                        <input type="text" name="pengirim" value="<?= $data1['pengirim']; ?>">
                        <br><br>
                        <label>Penerima :</label>
                        <input type="text" name="penerima" value="<?= $data1['penerima']; ?>">
                        <br><br>
                        <label>Posisi Pekerjaan :</label>
                        <input type="text" name="posisi" value="<?= $data1['posisi']; ?>">
                        <br><br>
                        <label>Tanggal pembelian : </label>
                        <input type="text" name="tgl_beli" id="tgl_beli" value="<?= $tanggal; ?>" autocomplete="off">
                        <br><br>
                        <label>lokasi :</label>
                        <input type="text" name="lokasi" value="<?= $data1['lokasi']; ?>">
                        <br><br>
                        <label>Kondisi :</label>
