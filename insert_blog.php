...
$query = "INSERT INTO tbl_home(nama_tipe, brand, detail_tipe, nomor_serial, pengirim, penerima, posisi, tgl_beli, lokasi, kondisi, deskripsi) 
            VALUES ('$nama_tipe','$brand','$detail_tipe','$nomor_serial','$pengirim','$penerima','$posisi','$tanggalBeli','$lokasi','$kondisi','$deskripsi')";
